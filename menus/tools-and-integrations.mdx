...
Tools & Integrations is found under the **Automations** section in the left navigation menu, alongside **Workflows**.
...
- **Integrations** — pre-built connections to third-party apps
...
The Integrations tab provides pre-built connections to third-party apps. Once connected, the integration's tools are automatically available to assign to your agents.

The tab shows three summary metrics:

| Metric | Description |
|--------|-------------|
| **Connected** | Integrations you have successfully connected |
| **Available** | Integrations available to connect |
| **Total** | Total integrations (connected + available) |

You can search integrations and filter by **Connected** or **Available**.

### Calendly

Connect Calendly to let your agents check availability and book meetings on your behalf.

**Tools included:**

| Tool | Description |
|------|-------------|
| `calendly_list_event_types` | List the event types available on your Calendly account |
| `calendly_check_availability` | Check available time slots for a given event type |
| `calendly_book_meeting` | Book a meeting through Calendly |

Click **Connect** on the Calendly card to link your Calendly account. Once connected, assign the Calendly tools to an agent from the agent's **Tools & Workflows** settings.

<Info>More integrations are coming soon.</Info>
